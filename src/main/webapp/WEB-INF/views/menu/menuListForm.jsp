...
<style type="text/css">
	#wrap { margin: auto; text-align: center; width: 1200px; }
	.menu { 
		font-size: 14pt; text-align: left; 
		padding-top: 20px; padding-bottom: 20px;
		border-bottom: 1px solid rgba(0, 0, 0, 0.1); 
	}
	#menu_list { margin: auto; border-bottom: 1px solid rgba(0, 0, 0, 0.1); margin-top: 30px; height: 1000px; width: 600px; }
	.menu_info { border-bottom: 1px solid rgba(0, 0, 0, 0.1); font-size: 18pt; text-align: left; padding: 10px; }
</style>
</head>
<body>
<div id="wrap">
